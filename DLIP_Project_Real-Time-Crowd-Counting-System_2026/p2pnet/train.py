...
def get_args_parser():
    ...
    parser.add_argument('--train_list', default=None,
                        help='comma-separated .list files for training (absolute or relative to data_root)')
    parser.add_argument('--val_list', default=None,
                        help='.list file for validation (absolute or relative to data_root)')
    ...
    parser.add_argument('--early_stop_patience', default=10, type=int,
                        help='stop if validation MAE does not improve for this many evaluations')
    parser.add_argument('--min_delta', default=0.01, type=float,
                        help='minimum MAE improvement to reset early stopping')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # save latest weights every epoch (full state for proper resume)
        ...
        if epoch % args.eval_freq == 0 and epoch != 0:
            ...
            with open(run_log_name, "a") as log_file:
                log_file.write("mae:{}, mse:{}, rel_mae_pct:{}, time:{}, best mae:{}".format(
