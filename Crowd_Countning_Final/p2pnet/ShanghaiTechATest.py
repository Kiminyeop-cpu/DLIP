...
_PART_A_CKPT = str(_REPO_ROOT / 'p2pnet' / 'ckpt_partA' / 'partA_best_mae.pth')
...
def get_args_parser():
    parser = argparse.ArgumentParser('P2PNet test – ShanghaiTech Part A', add_help=False)
    parser.add_argument('--backbone', default='vgg16_bn', type=str)
    parser.add_argument('--row',  default=2, type=int)
    parser.add_argument('--line', default=2, type=int)
    parser.add_argument('--weight_path', default=_PART_A_CKPT)
...
def main(args):
    ...
    print('Running evaluation on ShanghaiTech Part A ...\n')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('P2PNet Part A test', parents=[get_args_parser()])
